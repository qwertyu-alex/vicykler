...
public class TestAfData {
    ...
    public void testData() {
        ...
        for (Participant participant : participants) {
            System.out.printf("\n%-5d %-25s %-15s %-25s %-35s %-20s", i + 1, participants.get(i).getParticipantName(), participants.get(i).getCyclistType(), participants.get(i).getParticipantEmail(), teams.get(t).getTeamName(), firms.get(f).getFirmName());
